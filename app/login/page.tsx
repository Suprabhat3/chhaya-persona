        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-8 border border-white/20">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Continue your conversations with history's greatest minds
            </p>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-6">
            ...
            >
              ...
              <div className="relative bg-gradient-to-b from-purple-500 to-purple-600 hover:from-purple-400 hover:to-purple-500 text-white px-8 py-4 rounded-full font-medium text-lg border border-purple-400/50 shadow-sm">
                Sign In
              </div>
            </button>
          </form>
